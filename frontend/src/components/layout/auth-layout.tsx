  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-primary p-12 text-primary-foreground lg:flex">
        <Link to="/">
          <Logo className="[&_span:last-child]:text-primary-foreground [&_span:first-child]:bg-primary-foreground [&_span:first-child>span]:border-primary" />
        </Link>
        <div>
          <p className="text-sm uppercase tracking-widest opacity-70">Save together as</p>
          <RotatingText className="mt-3 font-serif text-5xl font-semibold [&_span:last-child]:opacity-70 [&_span:first-child]:text-primary-foreground" />
          <p className="mt-8 max-w-sm text-pretty leading-relaxed opacity-80">
            Transparent auctions, trust scoring, and instant payouts for community savings pools
            everywhere.
          </p>
        </div>
